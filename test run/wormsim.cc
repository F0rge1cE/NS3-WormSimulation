...
int main(int argc, char* argv[])
{
  ...
  //UniformVariable uv_time(0.0, 1.0);  //modify
  Ptr<UniformRandomVariable> uv_time = CreateObject<UniformRandomVariable> ();
  uv_time->SetAttribute ("Min", DoubleValue (0.0));
  uv_time->SetAttribute ("Max", DoubleValue (1.0));
